...
class _$LanguageModelImpl implements _LanguageModel {
  const _$LanguageModelImpl(
      {required this.name, @JsonKey(name: 'iso_639_1') required this.iso6391});
  ...
  @override
  String toString() {
    return 'LanguageModel(name: $name, iso6391: $iso6391)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, iso6391);
